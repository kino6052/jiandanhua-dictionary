...
## 1. Particles, Conjunctions, Prepositions, and Measure Words
...
## 2. Pronouns, Demonstratives, and Interrogatives
...
## 5. Quality, Property, and Colour

```dict
báisè | adjective/noun | white, pale, light-colored | walo
hēisè | adjective/noun | black, dark, unlit, obscure | pimeja
...
líkāi | verb/adjective | to leave, go away, depart; absent, ignored | weka
...
## 8. The Human Body and Physical Form
...
## 9. People, Kinship, and Social Groups
...
## 10. Food, Drink, and Edible Substances
...
## 11. Animals, Plants, and Natural Elements
...
## 12. Tools, Objects, Containers, and Substances
...
## 13. Abstract Concepts, Mind, Language, and Energy

```dict
ài | verb | to love, have compassion for, show deep affection to | olin
cí | noun | word |
fāngfǎ | noun | way, custom, path, road, method, doctrine | nasin
