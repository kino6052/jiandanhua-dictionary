...
- **Wishing Someone Something:** Reduplicating an adjective and binding the repeated pair with `-de` turns a plain description into a blessing rather than just a fact. `Hao-hao-de ri` doesn't only describe a good day, it wishes one on whoever you're speaking to. The hyphen keeps the doubling explicit -- the same way `hen-da-de` explicitly marks intensification -- instead of letting it blur into the kind of unmarked doubling spoken Mandarin does on its own.
...
Hao-hao-de ri! | Have a nice day!
Hǎo-hǎo juéde! | Thank you! (Literally, may you feel good)
```
