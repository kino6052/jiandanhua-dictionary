...
- **gōngjù** — tool, machine, device

- **yú** — fish, sea creature
...
2. **The A-bù-A / A-méi-A Construction:** Reduplicate the main verb or adjective with the negative particle `bù` (or `méi` if using the verb `yǒu`).

To answer "yes," simply repeat the main verb. To answer "no," repeat the verb alongside its negative particle, or use `bù` / `méiyǒu` on its own.
...
- `Tā yǒu-méi-yǒu hěn-duō-de shuǐguǒ?` (Does he have many vegetables/fruits?)

- `Yǒu.` (Yes. / He has.)

- `Nǐ tīng-bù-tīng fùmǔ?` (Do you obey your parents?)

- `Bù tīng.` (No. / I don't obey.)

- `Tā zài chī shénme?` (What is it eating?)
...
1. `Nǐ yǒu shénme gōngjù?`
2. `Tā tīng-bù-tīng?` (or `Tā tīng ma?`)
3. `Gōngjù xiǎo-bù-xiǎo?` (or `Gōngjù xiǎo ma?`)
...
- **shēngyīn** — sound, noise

- **jiào** — to call, make an animal sound (used alongside the Quote Partition)
...
- **Animal Sounds:** Handled via the core verb `jiào` paired with the Quote Partition, which isolates onomatopoeia inside quotation marks rather than treating them as new lexicon words.
...
3. The sun gives benefit to the plants.
...
## Lesson 12: Shùzì (Numbers and Order)
...
3. Do you want to eat some fish?
...
2. Protect your back.
3. What did you put the red clock next to?
...
- **xiàmiàn** — lowly, below, downward

- **bùtóng** — different, altered

- **hé** — and

- **lěng** — cold, cool

- **dòng** — door, hole, opening

- **kāishǐ** — to open, begin

- **yīyàng** — same, similar, sibling
